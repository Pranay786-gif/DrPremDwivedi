    ...
    >
      <Container maxWidth="md">
        ...
        <Paper
          ...
          sx={{
            background:
              "linear-gradient(135deg, rgba(233, 69, 96, 0.15) 0%, rgba(26, 26, 46, 0.8) 100%)",
        ...
        >
          ...
          >
            ...
            >
              premdwivedi.writer@outlook.com.au
            </MuiLink>
          </Stack>
          ...
          <Box
            sx={{
              ...
              height: "2px",
              background:
                "linear-gradient(90deg, transparent 0%, #e94560 50%, transparent 100%)",
              mx: "auto",
              mb: 4,
            }}
          />
